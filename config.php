...
// Pour tester en local, changez la ligne ci-dessous:
// define('DOSSIER_BASE_PATH', __DIR__ . '\test_docs');    // TEST LOCAL
if (!defined('DOSSIER_BASE_PATH')) {
    define('DOSSIER_BASE_PATH', '\\\\Nas-urbanisme\\permis de construire\\PLATEFORME\\PERMIS DE CONSTRUIRE');
    // Décommentez la ligne ci-dessous pour tester avec les fichiers locaux:
    // define('DOSSIER_BASE_PATH', __DIR__ . '\test_docs');
}
