...
// Ouvrir un dossier physique sur le NAS
// NOTE: Cette fonction ne peut pas ouvrir Explorer sur le poste client (limitation navigateur).
// Elle vérifie que le dossier existe et retourne son chemin pour information.
function openFolder() {
    ...
    if (is_dir($normalizedPath)) {
        sendJSON(200, 'Dossier accessible', [
            ...
            'exists' => true,
            'isOnNAS' => IS_ON_NAS,
            'info' => 'Pour ouvrir ce dossier, utilisez l\'Explorateur Windows : ' . $normalizedPath
        ]);
    } else {
