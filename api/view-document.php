...
if (!$dossiersBasePath) {
    error_log("⚠️ DOSSIER_BASE_PATH non configuré (null)");
...
if (!@is_dir($dossiersBasePath)) {
    ...
    echo '<p style="font-size:11px; text-align:center; color:#999;">Veuillez vérifier la connexion NAS et réessayer.</p>';
    echo '</body></html>';
    exit;
}
