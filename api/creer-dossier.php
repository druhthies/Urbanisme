...
if (!DOSSIER_BASE_PATH || DOSSIER_BASE_PATH === null) {
    http_response_code(503);
    echo json_encode(['status' => 503, 'message' => 'La base de données des documents n\'est pas configurée']);
    exit;
}

DOSSIER_BASE_PATH = '\\Nas-urbanisme\\permis de construire\\PLATEFORME\\PERMIS DE CONSTRUIRE';
